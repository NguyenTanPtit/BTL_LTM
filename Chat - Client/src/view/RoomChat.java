...
public class RoomChat extends javax.swing.JFrame implements Observer {
    ...
    public void update(Observable o, Object arg) {
        ...
        if (response.getResultType().equals(ResultFlags.ERROR)) {
            JOptionPane.showMessageDialog(null, response.getContent(), "Send failed", JOptionPane.ERROR_MESSAGE);
        } else {
            switch (response.getActionType()) {
                case ActionFlags.SEND_MESSAGE: {
                    
                    Message message = (Message) response.getEntity();
//                    if(room.getListUserRoom().size() == 2){
//                        System.out.println("id user room 0: "+ room.getListUserRoom().get(0).getId());
//                        System.out.println("id user room 1: "+ room.getListUserRoom().get(1).getId());
//                    }
                ...
                case ActionFlags.UPDATE_ROOM: {
                    Room roomr = (Room) response.getEntity();
                    if(roomr.getListUserRoom().size() == 2){
                        System.out.println("id user room 0: "+ roomr.getListUserRoom().get(0).getId());
                        System.out.println("id user room 1: "+ roomr.getListUserRoom().get(1).getId());
                    }
                    if (roomr.getId() == room.getId()) {
                        this.room = roomr;
                        lbRoomName.setText(roomr.getDescription());
                    }
                    break;
                }
            }
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(32, 32, 32)
                        .addComponent(btnLeave, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
